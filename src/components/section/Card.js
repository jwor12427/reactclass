...
const cardTitle = {
	title: "당신에게 친숙한 새들의 이야기",
	desc: "많은 이들과 함께하는 새, 까마귀, 까치, 비둘기에 대한 이야기를 풀어보아요🕊️",
};

const cardInfo = [
	{
		cardImg: "assets/img/card_bg01_01.jpg",
		cardAlt: "까마귀",
		cardTitle: "까마귀(Crow)",
		cardDesc:
			"까마귀는 조류 중에서도 까치, 앵무새와 함께 높은 지능을 가지고 있는 새입니다. 별다른 훈련없이 거울 속 자신을 알아보는 조류입니다. 까마귀는 종종 도구를 사용하는 모습을 보이기도 합니다.",
		cardLink: "/",
	},
	{
		cardImg: "assets/img/card_bg01_02.jpg",
		cardAlt: "까치",
		cardTitle: "까치(Oriental Magpie)",
		cardDesc:
			"적응력이 강한 까치는 사람이 사는 도시에서도 잘 살아가는 새입니다. 까치의 가장 돋보이는 특징은 긴 꼬리입니다. 까치의 앉은 모습을 보면 꽁치를 위아래로 까딱거리는 모습을 볼 수 있습니다.",
		cardLink: "/",
	},
	{
		cardImg: "assets/img/card_bg01_03.jpg",
		cardAlt: "비둘기",
		cardTitle: "비둘기(Rock dove)",
		cardDesc:
			"전세계 대도시에서 흔하게 볼수 있는 비둘기는 수명이 10년~ 20년으로 꽤 긴편에 속합니다. 주로 단체 생활을 하며 위협을 느낄 때는 특유의 '구르르'소리를 통해 의사를 전달합니다.",
		cardLink: "/",
	},
];

const CardMain = ({ cardImg, cardAlt, cardTitle, cardDesc, cardLink }) => {
	return (
...
function Card({ attr }) {
	return (
		<section
			id="cardType"
			className={`card__wrap ${attr[0]} ${attr[1]}`}
		>
